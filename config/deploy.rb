...
set :user,            'deployer'
set :repo_url,        'git@github.com:guiRibas/walgprog.git'
set :keep_releases,   3
...
# The default is “0”
# puma will fork its operating system process however many times you set via
# workers configuration to respond to http requests. This gives you parallelism
# in terms of handling multiple requests but this will usually take up more
# memory as it will 'copy' your application code for each worker
...
# Preloading your application reduces the startup time of individual Puma
# worker processes and allows you to manage the external connections of each
# individual worker using the on_worker_boot calls. In the config above, these
# calls are used to correctly establish Postgres connections for each worker
# process.
...
production:
  ...
  db.host: localhost
  mailer.host: walgprog.tsi.pro.br
  mailer.port: '80'
  mailer.from: 'noreply.walgprog@gmail.com'
  mailer.smtp: 'smtp.gmail.com'
  mailer.smtp.port: '587'
  mailer.smtp.domain: 'walgprog.tsi.pro.br'
